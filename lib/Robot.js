...
Robot.prototype.Place = (x,y,face) => {
  this.x_length = 4;
  this.y_length = 4;
  x !== null ? Robot.prototype.SetX(x) :console.log('Invalid PLACE command incomplete')
  y !== null ? Robot.prototype.SetY(y) : console.log('Invalid PLACE command incomplete')
  face !== null ? Robot.prototype.SetFace(face) : console.log('Invalid PLACE command incomplete')
};
